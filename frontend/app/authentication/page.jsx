      ...
      <div className="flex min-h-screen">
        <div className="w-1/2 pr-0 bg-white  flex flex-col items-center justify-center">
          ...
          <div className="w-full">
            {/* Auth Card */}
            <div className="transition duration-500 w-1/2 mx-auto">
              <div className="px-8 py-10">
               ...
               bg-white px-1"
                      ...
                      {otpSent && (
                        <>
                          <div className="w-full relative animate-scaleIn">
                            <input
                              type="text"
                              name="otp"
                              id="otp"
               ...
               bg-white px-1"
                  ...
                  {isLogin && !resetPassword && (
                    <>
                      <div className="w-full relative field-group">
                        <input
                          type="email"
                          name="email"
                          id="email"
              ...
              {/* Footer Links */}
              <div className="py-6 border-t border-slate-200 rounded-b-2xl">
                {isLogin && !resetPassword && (
              ...
              <div className="text-slate-500 text-sm mt-4 text-center select-none">
                © 2025 LifeCraft. All rights reserved. <br /> Secure authentication system.
              </div>
            </div>
          </div>
        </div>
                      ...
                      <>
                        <div className="field-group">
                          ...
                          <input
                            ...
                            value={formData.name}
                            onChange={handleChange}
                            className="w-full px-4 py-3 border border-slate-300 rounded-lg text-slate-900 focus:ring-2 focus:ring-slate-800 transition outline-none input-focus bg-white"
                            required
                            disabled={otpSent}
                          />
                        </div>
